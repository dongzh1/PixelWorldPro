                    ...
                    for (dimension in dimensionlist) {
                        if (PixelWorldPro.instance.config.getBoolean("debug")) {
                            Bukkit.getConsoleSender()
                                .sendMessage("§aPixelWorldPro 扩展世界 ${worldData.worldName.lowercase(Locale.getDefault()) + "/" + dimension} 的边界")
                        }
                        val worlds =
                            Bukkit.getWorld(worldData.worldName.lowercase(Locale.getDefault()) + "/" + dimension)
                        if (worlds != null) {
                            //世界边界更新
                            ...
                            if (PixelWorldPro.instance.config.getBoolean("debug")) {
                                Bukkit.getConsoleSender()
                                    .sendMessage("§aPixelWorldPro 扩展世界 ${worldData.worldName.lowercase(Locale.getDefault()) + "/" + dimension} 的边界失败：世界不存在")
                            }
                        }
                    }
                    return lang("LevelUp")
