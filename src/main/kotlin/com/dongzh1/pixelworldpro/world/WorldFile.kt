    ...
    fun setWorldLocation(world: World) {
        ...
        if (worldSetting.getInt("location.max") > 0) {
            ...
            while (times < maxTimes) {
                ...
                try {
                    if ((block1.blockData.material == org.bukkit.Material.AIR).and(block2.blockData.material == org.bukkit.Material.AIR)
                            .and(block3.blockData.material == org.bukkit.Material.AIR)
                            .and(block4.blockData.material == org.bukkit.Material.AIR)
                    ) {
